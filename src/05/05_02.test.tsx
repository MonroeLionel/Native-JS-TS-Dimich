...
test(`привественное сообщение для жителей улиц`, () => {

   let messages = createMessage(city.houses)
   expect(messages.length).toBe(3)
   expect(messages[0]).toBe(`Hello guy from White street`)
   expect(messages[1]).toBe(`Hello guy from Happy street`)
   expect(messages[2]).toBe(`Hello guy from Happy street`)
})